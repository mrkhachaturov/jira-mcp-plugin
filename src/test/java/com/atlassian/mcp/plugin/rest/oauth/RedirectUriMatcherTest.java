...
public class RedirectUriMatcherTest {
    ...
    public void matchesExactUri() {
        assertTrue(RedirectUriMatcher.matches("https://app.example/cb",
                List.of("https://app.example/cb")));
    }
    ...
    public void rejectsDifferentLoopbackHost() {
        assertFalse(RedirectUriMatcher.matches("http://127.0.0.1:62127/callback",
    ...
    public void doesNotRelaxPortForNonLoopbackHosts() {
        assertFalse(RedirectUriMatcher.matches("https://app.example:8443/cb",
                List.of("https://app.example/cb")));
    }
