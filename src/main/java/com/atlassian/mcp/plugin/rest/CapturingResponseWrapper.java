...
/**
 * Captures the {@code MCP-Session-Id} header (and final status code) as the SDK writes them, so
 * {@link SessionBindingFilter} can record the binding post-initialize without consuming the stream.
 */
