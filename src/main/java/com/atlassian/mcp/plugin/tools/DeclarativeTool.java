 ...
 * hand. {@link #inputSchema()} and {@link #execute} are final: a subclass has no way to advertise a
 * parameter the schema does not contain, or to reach past {@link ToolArgs} for one it never
