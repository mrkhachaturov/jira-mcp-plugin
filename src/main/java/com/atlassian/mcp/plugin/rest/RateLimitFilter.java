...
/**
 * Per-user (or per-IP for anonymous) rate limit on the MCP endpoint. 120/min. Returns 429 on
 * overflow. Reuses the shared {@link RateLimiter} component.
 *
 * <p>Emits {@code RateLimit-Limit}, {@code RateLimit-Remaining}, {@code RateLimit-Reset} response
 * headers on every authenticated MCP response per <a
 * href="https://datatracker.ietf.org/doc/draft-ietf-httpapi-ratelimit-headers/">
 * draft-ietf-httpapi-ratelimit-headers-09</a>. Also sets {@code Retry-After} on 429 per RFC 9110
 * §10.2.3.
 */
@UnrestrictedAccess
...
public class RateLimitFilter implements Filter {
  ...
  @Inject
  public RateLimitFilter(RateLimiter rateLimiter, @ComponentImport UserManager userManager) {
