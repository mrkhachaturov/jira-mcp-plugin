            ...
            Map.of(
                "issues",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "JSON array of issue objects. Each object should contain: - project_key (required): The project key (e.g., 'PROJ') - summary (required): Issue summary/title - issue_type (required): Type of issue (e.g., 'Task', 'Bug') - description (optional): Issue description in Markdown format - assignee (optional): Assignee username or email - components (optional): Array of component names Example: [ {\"project_key\": \"PROJ\", \"summary\": \"Issue 1\", \"issue_type\": \"Task\"}, {\"project_key\": \"PROJ\", \"summary\": \"Issue 2\", \"issue_type\": \"Bug\", \"components\": [\"Frontend\"]} ]"),
                "validate_only",
                    Map.of(
                        "type",
                        "boolean",
                        "description",
                        "If true, only validates the issues without creating them",
                        "default",
                        false)),
