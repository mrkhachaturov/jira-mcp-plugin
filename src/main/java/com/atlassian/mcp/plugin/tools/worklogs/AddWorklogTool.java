            ...
            Map.of(
                ...
                "time_spent",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "Time spent in Jira format. Examples: '1h 30m' (1 hour and 30 minutes), '1d' (1 day), '30m' (30 minutes), '4h' (4 hours)"),
                "comment",
                    Map.of(
                        "type",
                        "string",
                ...
                "original_estimate",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "(Optional) New value for the original estimate"),
                "remaining_estimate",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "(Optional) New value for the remaining estimate")),
