            ...
            Map.of(
                ...
                "fields",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "(Optional) Comma-separated list of fields to filter changelogs by (e.g. 'status,assignee'). Default to None for all fields."),
                "limit",
                    Map.of(
                        "type",
                        "integer",
                        "description",
                        "Maximum number of changelogs to return in result for each issue. Default to -1 for all changelogs.",
                        "default",
                        -1)),
