...
// Ported from mcp-atlassian v0.21.0 -- src/mcp_atlassian/servers/jira.py:get_transitions
...
public class GetTransitionsTool implements McpTool {
    ...
    public GetTransitionsTool(JiraRestClient client) { this.client = client; }

    @Override public String name() { return "get_transitions"; }
    @Override public String description() { return "Get available status transitions for a Jira issue."; }
    ...
    public String execute(Map<String, Object> args, String authHeader) throws McpToolException {
        ...
        return client.get("/rest/api/2/issue/" + issueKey + "/transitions", authHeader);
    }
}
