 ...
 * <ul>
 *   <li>advertise their widget via {@link McpTool#uiResourceUri()} (using
 *       {@link ResourceRegistry#getResourceUri()}), and</li>
 *   <li>emit {@code structuredContent} for the issue-card widget via
 *       {@link ResourceContextBuilder#build(String, String, String, String)}.</li>
 * </ul>
 *
 * <p>Both fields may be {@code null} when MCP Apps is unavailable (no widget HTML
 * on the classpath) — UI-linked tools must treat both as nullable and short-circuit
 * gracefully.
 */
