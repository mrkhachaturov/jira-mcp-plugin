 ...
 *
 * <p>The Jira Software wordmark is used both as the server-level icon (via {@code
 * Implementation.icons}) and as the per-tool icon for the five UI-linked tools whose {@code
 * structuredContent} renders as an MCP Apps widget in compatible clients (Claude Desktop, ChatGPT,
 * VS Code Copilot).
 */
