...
public class GetIssueDatesTool implements McpTool {
    ...
    public String execute(Map<String, Object> args, String authHeader) throws McpToolException {
        ...
        String sep = "?";
        if (created,updated,duedate,resolutiondate != null && !created,updated,duedate,resolutiondate.isBlank()) {
            query.append(sep).append("fields=").append(encode(created,updated,duedate,resolutiondate));
            sep = "&";
        }
