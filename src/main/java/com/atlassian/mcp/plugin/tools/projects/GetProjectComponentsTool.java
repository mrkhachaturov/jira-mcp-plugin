...
public class GetProjectComponentsTool implements McpTool {
    ...
    public GetProjectComponentsTool(JiraRestClient client) { this.client = client; }
    @Override public String name() { return "get_project_components"; }
    @Override public String description() { return "Get components defined in a Jira project."; }
    ...
    @Override public String execute(Map<String, Object> args, String authHeader) throws McpToolException {
        ...
        return client.get("/rest/api/2/project/" + pk + "/components", authHeader);
    }
}
