            ...
            Map.of(
                "link_type",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "The type of link to create (e.g., 'Duplicate', 'Blocks', 'Relates to')"),
                "inward_issue_key",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "The key of the inward issue (e.g., 'PROJ-123', 'ACV2-642')"),
                "outward_issue_key",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "The key of the outward issue (e.g., 'PROJ-456')"),
                "comment",
                    Map.of(
                        "type", "string", "description", "(Optional) Comment to add to the link"),
                "comment_visibility",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "(Optional) Visibility settings for the comment as JSON string (e.g. '{\"type\":\"group\",\"value\":\"jira-users\"}')")),
