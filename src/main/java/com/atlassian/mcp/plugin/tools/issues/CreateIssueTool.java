            ...
            Map.of(
                "project_key",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "The JIRA project key (e.g. 'PROJ', 'DEV', 'ACV2'). This is the prefix of issue keys in your project. Never assume what it might be, always ask the user."),
                ...
                "description",
                    Map.of("type", "string", "description", "Issue description in Markdown format"),
                "components",
                    Map.of(
                        "type",
                        "string",
