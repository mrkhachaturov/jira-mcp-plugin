            ...
            Map.of(
                "issue_key",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "The key of the issue to add the link to (e.g., 'PROJ-123', 'ACV2-642')"),
                "url",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "The URL to link to (e.g., 'https://example.com/page' or Confluence page URL)"),
                "title",
                    Map.of(
                        "type",
                        "string",
                        "description",
                        "The title/name of the link (e.g., 'Documentation Page', 'Confluence Page')"),
                "summary",
                    Map.of("type", "string", "description", "(Optional) Description of the link"),
                "relationship",
                    Map.of(
                        "type",
                        "string",
                ...
                "icon_url",
                    Map.of(
                        ...
                        "string",
                        "description",
                        "(Optional) URL to a 16x16 icon for the link")),
