...
public class JiraMarkupConverterTest {
  ...
  public void jiraToMd_headers() {
    ...
    assertEquals(
        "###### Smallest heading", JiraMarkupConverter.jiraToMarkdown("h6. Smallest heading"));
  }
  ...
  public void jiraToMd_image() {
    assertEquals("![](screenshot.png)", JiraMarkupConverter.jiraToMarkdown("!screenshot.png!"));
  }

  @Test
  public void jiraToMd_imageWithAlt() {
    assertEquals("![logo](logo.png)", JiraMarkupConverter.jiraToMarkdown("!logo.png|alt=logo!"));
  }

  @Test
  public void jiraToMd_bulletList() {
    assertEquals("- item 1\n- item 2", JiraMarkupConverter.jiraToMarkdown("* item 1\n* item 2"));
  }

  @Test
  public void jiraToMd_numberedList() {
    assertEquals("1. first\n1. second", JiraMarkupConverter.jiraToMarkdown("# first\n# second"));
  }
  ...
  public void jiraToMd_userMention() {
    assertEquals("@jsmith", JiraMarkupConverter.jiraToMarkdown("[~jsmith]"));
  }
  ...
  public void jiraToMd_citation() {
    assertEquals(
        "<cite>some citation</cite>", JiraMarkupConverter.jiraToMarkdown("??some citation??"));
  }

  @Test
  public void jiraToMd_insertedText() {
    assertEquals("<ins>inserted</ins>", JiraMarkupConverter.jiraToMarkdown("+inserted+"));
  }

  @Test
  public void jiraToMd_superscript() {
    assertEquals("<sup>super</sup>", JiraMarkupConverter.jiraToMarkdown("^super^"));
  }

  @Test
  public void jiraToMd_subscript() {
    assertEquals("<sub>sub</sub>", JiraMarkupConverter.jiraToMarkdown("~sub~"));
  }
  ...
  public void mdToJira_angleLink() {
    assertEquals(
        "[http://example.com]", JiraMarkupConverter.markdownToJira("<http://example.com>"));
  }

  @Test
  public void mdToJira_image() {
    assertEquals("!screenshot.png!", JiraMarkupConverter.markdownToJira("![](screenshot.png)"));
  }

  @Test
  public void mdToJira_imageWithAlt() {
    assertEquals("!logo.png|alt=Logo!", JiraMarkupConverter.markdownToJira("![Logo](logo.png)"));
  }

  @Test
  public void mdToJira_bulletList() {
    assertEquals("* item 1\n* item 2", JiraMarkupConverter.markdownToJira("- item 1\n- item 2"));
  }

  @Test
  public void mdToJira_numberedList() {
    assertEquals("# first\n# second", JiraMarkupConverter.markdownToJira("1. first\n2. second"));
  }
  ...
  public void mdToJira_strikethrough() {
    assertEquals("-deleted-", JiraMarkupConverter.markdownToJira("~~deleted~~"));
  }
  ...
  public void mdToJira_htmlCite() {
    assertEquals("??cited text??", JiraMarkupConverter.markdownToJira("<cite>cited text</cite>"));
  }

  @Test
  public void mdToJira_htmlDel() {
    assertEquals("-deleted-", JiraMarkupConverter.markdownToJira("<del>deleted</del>"));
  }

  @Test
  public void mdToJira_htmlIns() {
    assertEquals("+inserted+", JiraMarkupConverter.markdownToJira("<ins>inserted</ins>"));
  }

  @Test
  public void mdToJira_htmlSup() {
    assertEquals("^super^", JiraMarkupConverter.markdownToJira("<sup>super</sup>"));
  }

  @Test
  public void mdToJira_htmlSub() {
    assertEquals("~sub~", JiraMarkupConverter.markdownToJira("<sub>sub</sub>"));
  }

  @Test
  public void mdToJira_userMention() {
    assertEquals("[~jsmith]", JiraMarkupConverter.markdownToJira("@jsmith"));
  }

  @Test
  public void mdToJira_blockquote() {
    assertEquals("bq. This is a quote", JiraMarkupConverter.markdownToJira("> This is a quote"));
  }
